...
namespace Assignment_UWP.Pages
{
    ...
    /// </summary>
    public sealed partial class CreateSongAll : Windows.UI.Xaml.Controls.Page
    {
        private static string publicIDCloudinary;
        private CloudinaryDotNet.Account accountCloudinary;
        private Cloudinary cloudinary;
        private int checkValid = 0;
        public CreateSongAll()
        {
            this.InitializeComponent();
            this.Loaded += CreateSongAll_Loaded;
        }

        private void CreateSongAll_Loaded(object sender, RoutedEventArgs e)
        {
